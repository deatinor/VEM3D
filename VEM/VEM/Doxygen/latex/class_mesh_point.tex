...
\subsubsection*{template$<$long embedded, typename real = double$>$class Mesh\-Point$<$ embedded, real $>$}
...
\hypertarget{class_mesh_point_a9fce0473490e3f1447d6adc100df166a}{\index{\-Mesh\-Point@{\-Mesh\-Point}!\-Mesh\-Point@{\-Mesh\-Point}}
\index{\-Mesh\-Point@{\-Mesh\-Point}!MeshPoint@{\-Mesh\-Point}}
\subsubsection[{\-Mesh\-Point}]{\setlength{\rightskip}{0pt plus 5cm}template$<$long embedded, typename real = double$>$ template$<$typename... \-Args$>$ {\bf \-Mesh\-Point}$<$ embedded, real $>$\-::{\bf \-Mesh\-Point} (
\begin{DoxyParamCaption}
\item[{\-Args...}]{arguments}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}\label{class_mesh_point_a9fce0473490e3f1447d6adc100df166a}
...
\hypertarget{class_mesh_point_a429995d48aa19e82d8beccf3068a8851}{\index{\-Mesh\-Point@{\-Mesh\-Point}!operator$<$@{operator$<$}}
\index{operator$<$@{operator$<$}!MeshPoint@{\-Mesh\-Point}}
\subsubsection[{operator$<$}]{\setlength{\rightskip}{0pt plus 5cm}template$<$long embedded, typename real $>$ bool {\bf \-Mesh\-Point}$<$ embedded, real $>$\-::operator$<$ (
\begin{DoxyParamCaption}
\item[{{\bf \-Mesh\-Point}$<$ embedded, real $>$ \&}]{input\-Point}
\end{DoxyParamCaption}
)}}\label{class_mesh_point_a429995d48aa19e82d8beccf3068a8851}


\-Get a weak pointer to a \hyperlink{class_polyhedron}{\-Polyhedron} in polyhedron\-Vector. 

it compares point\-I\-D 

\subsection{\-Member \-Data \-Documentation}
\hypertarget{class_mesh_point_a114d5fed31c8ca38751e66ebf9a6648a}{\index{\-Mesh\-Point@{\-Mesh\-Point}!polygon\-Vector@{polygon\-Vector}}
\index{polygon\-Vector@{polygon\-Vector}!MeshPoint@{\-Mesh\-Point}}
\subsubsection[{polygon\-Vector}]{\setlength{\rightskip}{0pt plus 5cm}template$<$long embedded, typename real = double$>$ vector$<$weak\-\_\-ptr$<${\bf \-Polygon}$<$embedded, real$>$ $>$ $>$ {\bf \-Mesh\-Point}$<$ embedded, real $>$\-::{\bf polygon\-Vector}\hspace{0.3cm}{\ttfamily  \mbox{[}protected\mbox{]}}}}\label{class_mesh_point_a114d5fed31c8ca38751e66ebf9a6648a}


\-Vector of \hyperlink{class_polygon}{\-Polygon} with this \hyperlink{class_mesh_point}{\-Mesh\-Point} as vertex. 

weak\-\_\-ptr necessary to not create loop pointers \hypertarget{class_mesh_point_a675c54208346d021ad9a90e382f9c1d3}{\index{\-Mesh\-Point@{\-Mesh\-Point}!polyhedron\-Vector@{polyhedron\-Vector}}
\index{polyhedron\-Vector@{polyhedron\-Vector}!MeshPoint@{\-Mesh\-Point}}
\subsubsection[{polyhedron\-Vector}]{\setlength{\rightskip}{0pt plus 5cm}template$<$long embedded, typename real = double$>$ vector$<$weak\-\_\-ptr$<${\bf \-Polyhedron}$<$embedded,real$>$ $>$ $>$ {\bf \-Mesh\-Point}$<$ embedded, real $>$\-::{\bf polyhedron\-Vector}\hspace{0.3cm}{\ttfamily  \mbox{[}protected\mbox{]}}}}\label{class_mesh_point_a675c54208346d021ad9a90e382f9c1d3}
